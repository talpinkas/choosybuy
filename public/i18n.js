...
var I18N = {
  he: {
    ...
    start: 'בואו נתחיל',
    hero_sub_short: 'במקום עשרות אפשרויות מבלבלות, שניים בכל פעם עד שמוצאים.',
    trust_line: 'חינם · בלי הרשמה · קונים בחנות שאתם מכירים',
    ...
    cat_outerwear: 'מעילים', cat_nightwear: 'פיג\'מות', cat_shoes: 'נעליים',
    cat_hats: 'כובעים', cat_socks: 'גרביים', cat_bags: 'תיקים', cat_sunglasses: 'משקפי שמש',
    grp_clothing: 'ביגוד', grp_shoes: 'נעליים', grp_accessories: 'אקססוריז',
    label_vibe: 'סגנון', label_more: 'עוד',
    style_casual: 'יומיומי', style_sporty: 'ספורטיבי', style_dressy: 'אלגנט', style_school: 'בית ספר',
    style_beach: 'חוף', style_sleep: 'לשינה', style_holiday: 'חג', style_other: 'אחר',
    filter_sale: 'רק במבצע', filter_multipack: 'רק מארזים', filter_nosets: 'בלי סטים',
    few_items: 'נמצאו מעט פריטים — נרחיב כדי לתת לכם בחירה טובה',
  ...
  en: {
    ...
    start: 'Let\'s start',
    hero_sub_short: 'Instead of endless options, two at a time until you find it.',
    trust_line: 'Free · no signup · buy at the store you know',
    ...
    cat_outerwear: 'Outerwear', cat_nightwear: 'Pajamas', cat_shoes: 'Shoes',
    cat_hats: 'Hats', cat_socks: 'Socks', cat_bags: 'Bags', cat_sunglasses: 'Sunglasses',
    grp_clothing: 'Clothing', grp_shoes: 'Shoes', grp_accessories: 'Accessories',
    label_vibe: 'Style', label_more: 'More',
    style_casual: 'Everyday', style_sporty: 'Sporty', style_dressy: 'Dressy', style_school: 'School',
    style_beach: 'Beach', style_sleep: 'Sleep', style_holiday: 'Holiday', style_other: 'Other',
    filter_sale: 'On sale only', filter_multipack: 'Multipacks only', filter_nosets: 'No sets',
    few_items: 'Few items found — we\'ll widen to give you a good choice',
